...
<head>
    ...
    <title>myaccount School Portal</title>
    ...
    <meta property="site_name" content="myaccount School Portal"/>
    <meta property="description" content="Prototype of myaccount School Portal for accessing online school services." />
    <meta name="description" content="Prototype of myaccount School Portal for accessing online school services." />
...
<header>
    <nav class="frame" role="navigation">
        <div class="container-fluid">
            <a href="" class="brand">
                myaccount
                <small class="text-muted hidden-xs">School Portal Prototype</small>
            </a>
            <div class="buttons pull-right">
                ...
                <a href="https://www.almsaeedstudio.com/premium" data-toggle="tooltip" data-placement="bottom" title="Premium Templates"><i  style="color: #F34D59" class="fa fa-tint fa-lg"></i></a>
                <a href="https://www.almsaeedstudio.com/download/AdminLTE-master" data-toggle="tooltip" data-placement="bottom" title="Download now"><i class="fa fa-download fa-lg"></i></a>
